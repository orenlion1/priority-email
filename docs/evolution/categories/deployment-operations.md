...
| 2026-06-21 | PVC-backed checkpointing was attempted but deferred because the reference EKS cluster has no EBS CSI add-on installed. Durable checkpoints remain planned for DynamoDB. | `DEPLOYMENT_PLAN.md`, `infra/k8s/deployment.yaml` |
